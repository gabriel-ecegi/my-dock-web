...
export const postAuthSignIn = (requestContract: SignInRequest, headers = new Headers()): 
	Promise<PostAuthSignInFetchResponse> => 
	apiPost(`${API_URL}/api/auth/sign-in`, requestContract, headers) as Promise<PostAuthSignInFetchResponse>;
...
export const getAuthUserInfo = (headers = new Headers()): 
	...
	return apiGet(`${API_URL}/api/auth/user-info`, headers, {}) as Promise<GetAuthUserInfoFetchResponse>;
}
...
export const postAuthSignOut = (headers = new Headers()): 
	Promise<PostAuthSignOutFetchResponse> => 
	apiPost(`${API_URL}/api/auth/sign-out`, {}, headers) as Promise<PostAuthSignOutFetchResponse>;

export type GetClientsFetchResponse = 
| FetchResponse<ClientDto[], 200> 
| ErrorResponse;

export const getClients = (headers = new Headers()): 
	Promise<GetClientsFetchResponse> => {
	return apiGet(`${API_URL}/api/clients`, headers, {}) as Promise<GetClientsFetchResponse>;
}
...
export const getClientsId = (id: number, headers = new Headers()): 
	Promise<GetClientsIdFetchResponse> => {
	return apiGet(`${API_URL}/api/clients/${id}`, headers, {}) as Promise<GetClientsIdFetchResponse>;
}
